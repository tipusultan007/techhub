        ...
        <table class="items-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 10%; text-align: right;">Amount (Incl. VAT)</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td align="right" style="font-weight: 400; color: #0f172a;">{{ number_format($item->subtotal + $item->tax_amount, 2) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
