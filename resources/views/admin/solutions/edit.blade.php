...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Edit Solution: {{ $solution->title }}</h1>
    </div>

    <form action="{{ route('solutions.admin.update', $solution->id) }}" method="POST" class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
        @csrf
        @method('PUT')
        <div class="p-6 md:p-8 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="icon_class" id="icon_class" value="{{ old('icon_class', $solution->icon_class) }}" 
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                        placeholder="e.g. ri-router-line">
                    <p class="text-xs text-gray-400">Current: <i class="{{ $solution->icon_class }} ml-1"></i>. Use <a href="https://remixicon.com/" target="_blank" class="text-blue-500 underline">Remix Icons</a> classes.</p>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="summary" id="summary" rows="3" required
                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                    placeholder="Briefly describe what this solution covers (shown on cards)...">{{ old('summary', $solution->summary) }}</textarea>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" class="tinymce">{{ old('description', $solution->description) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-50">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order', $solution->order) }}" 
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none">
                </div>
                ...
                <div class="flex items-center pt-8">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" class="sr-only peer" {{ $solution->is_active ? 'checked' : '' }}>
            ...
            <div class="pt-6 border-t border-gray-100 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $solution->meta_title) }}" 
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="meta_description" id="meta_description" rows="3"
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                        placeholder="Brief SEO description...">{{ old('meta_description', $solution->meta_description) }}</textarea>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="meta_keywords" id="meta_keywords" rows="2"
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                        placeholder="keyword1, keyword2, ...">{{ old('meta_keywords', $solution->meta_keywords) }}</textarea>
        ...
        <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button type="submit" class="px-8 py-2 bg-blue-600 text-white rounded-lg font-bold text-sm hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all">Update Solution</button>
        </div>
    </form>
</div>
@endsection
