...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/30">
            <h3 class="text-xl font-bold text-gray-900 tracking-tight">Register New Customer</h3>
            <p class="text-xs text-gray-500 mt-1 uppercase font-bold tracking-widest">Create a new contact profile in the CRM</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="3" 
                              class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 font-bold text-gray-900 transition-all outline-none"
                              placeholder="Full delivery/billing address details...">{{ old('address') }}</textarea>
                </div>
            </div>
